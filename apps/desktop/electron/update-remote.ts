 ...
 *
 * A public install can end up with `origin=git@github.com:Ansatz-agent/hermes-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/Ansatz-agent/hermes-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/ansatz-agent/hermes-agent'
