...
desktop app** (`ansatz desktop`) SDK — the `@hermes/plugin-sdk` module and
`$HERMES_HOME/desktop-plugins/`. The **web dashboard** (`ansatz dashboard`) has
...
toast naming the failure, and tail `ansatz logs gui -f`.
