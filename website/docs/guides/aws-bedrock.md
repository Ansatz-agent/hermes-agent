...
Bedrock models use **inference profile IDs** for on-demand invocation. The `ansatz model` picker shows these automatically, with recommended models at the top:
