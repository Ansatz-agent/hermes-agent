...
ansatz skills install official/research/arxiv
...
ansatz skills config gif-search

# View all skill config
ansatz config get skills.config --json
```
...
```bash
ansatz chat -q "/my-skill help me with the thing"
```
