...
- **Don't see the model in the list?** Make sure you finished the Nous Portal connection and that you're on the **Free** plan. In the CLI, `ansatz portal info` confirms you're logged in and routing through Nous.
