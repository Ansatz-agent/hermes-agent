...
install_desktop() {
    ...
    if [ "$OS" = "linux" ]; then
        ...
        local cand
        for cand in \
            "$desktop_dir/release/mac-arm64/Ansatz.app" \
            "$desktop_dir/release/mac/Ansatz.app" \
