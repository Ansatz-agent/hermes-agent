"""``ansatz verify`` — detect a project's run recipe and smoke-test it.
...
(:mod:`agent.verification_evidence`), so a passing ``ansatz verify`` satisfies
