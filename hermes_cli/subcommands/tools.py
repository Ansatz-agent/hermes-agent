"""``ansatz tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'ansatz tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # ansatz tools list [--platform cli]
    ...
    # ansatz tools disable <name...> [--platform cli]
    ...
    # ansatz tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `ansatz tools` runs after you pick a provider that\n"
