"""ansatz memory setup|status — configure memory provider plugins.
...
def _provider_pip_dependencies(provider_name: str, declared: list) -> list:
    ...
    ``ansatz memory setup`` — if the update-time refresh only reinstalled
...
# ---------------------------------------------------------------------------
# Curses-based interactive picker (same pattern as ansatz tools)
# ---------------------------------------------------------------------------
...
def _install_dependencies(provider_name: str, *, force: bool = False) -> None:
    ...
    ranges. This is how ``ansatz update`` heals the active memory provider
...
def cmd_setup_provider(provider_name: str) -> None:
    ...
    if not match:
        ...
        print("  Run 'ansatz memory setup' to see available providers.\n")
        return
