"""CLI handlers for ``ansatz secrets onepassword ...``.
...
def cmd_setup(args: argparse.Namespace) -> int:
    ...
    console.print(
        "  Map credentials:  [cyan]ansatz secrets onepassword set OPENAI_API_KEY "
        "\"op://Private/OpenAI/api key\"[/cyan]\n"
        "  Preview:          [cyan]ansatz secrets onepassword sync[/cyan]\n"
        "  Status:           [cyan]ansatz secrets onepassword status[/cyan]"
    )
    return 0
...
def cmd_status(args: argparse.Namespace) -> int:
    ...
    if not enabled:
        console.print("\n  Run [cyan]ansatz secrets onepassword setup[/cyan] to enable.")
        return 0
    ...
    if not references:
        console.print(
            ...
            "[cyan]ansatz secrets onepassword set ENV_VAR \"op://…\"[/cyan]"
        )
    return 0
...
def cmd_set(args: argparse.Namespace) -> int:
    ...
    if not op_cfg.get("enabled"):
        console.print(
            ...
            "[cyan]ansatz secrets onepassword setup[/cyan] to turn it on.[/yellow]"
        )
    return 0
...
def cmd_token(args: argparse.Namespace) -> int:
    ...
    if not op_cfg.get("enabled"):
        console.print(
            ...
            "run `ansatz secrets onepassword setup` to turn it on.[/yellow]"
        )
    return 0
...
def cmd_sync(args: argparse.Namespace) -> int:
    ...
    if not op_cfg.get("enabled"):
        console.print(
            ...
            "`ansatz secrets onepassword setup` first.[/yellow]"
        )
        return 1
    ...
    if not references:
        console.print(
            ...
            "`ansatz secrets onepassword set ENV_VAR \"op://…\"`.[/yellow]"
        )
        return 0
...
def cmd_disable(args: argparse.Namespace) -> int:
    ...
    console.print(
        ...
        "[cyan]ansatz secrets onepassword remove ENV_VAR[/cyan] if you no longer "
        "need them."
    )
    return 0
