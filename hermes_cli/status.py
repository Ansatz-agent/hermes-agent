...
def show_status(args):
    ...
    print(
        ...
        f"{'logged in' if minimax_logged_in else 'not logged in (run: hermes provider add minimax-oauth)'}"
    )
    ...
    print(
        ...
        f"{'logged in' if xai_oauth_logged_in else 'not logged in (run: hermes provider add xai-oauth)'}"
    )
